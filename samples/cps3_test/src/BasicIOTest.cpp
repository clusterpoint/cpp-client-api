...
void BasicIOTest::test_insert_one_document_and_delete_it() {
	...
	docs_vector.push_back("<document><id>test_insert_one_document_and_delete_it</id><title>Test document 1</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
	// Insert document
...
void BasicIOTest::test_insert_many_documents_and_delete_them() {
	static const char* doc_template = "<document><id>{ID}</id><title>Test document 1</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>";
...
void BasicIOTest::test_insert_one_document_update_it_and_then_delete_it() {
	std::vector<std::string> docs_vector;
	docs_vector.push_back("<document><id>test_insert_one_document_update_it_and_then_delete_it</id><title>Test document 1</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
	// Insert document
	CPS::InsertRequest insert_req(docs_vector);
	std::unique_ptr<CPS::InsertResponse> insert_resp(
			connection().sendRequest<CPS::InsertResponse>(insert_req));
...
void BasicIOTest::test_insert_one_document_retrieve_it_and_then_delete_it() {
	std::vector<std::string> docs_vector;
	docs_vector.push_back("<document><id>test_insert_one_document_retrieve_it_and_then_delete_it</id><title>Test document 1</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
	// Insert document
	CPS::InsertRequest insert_req(docs_vector);
	std::unique_ptr<CPS::InsertResponse> insert_resp(
			connection().sendRequest<CPS::InsertResponse>(insert_req));
...
void BasicIOTest::test_insert_one_document_partially_replace_it_retrieve_it_and_then_delete_it() {
	std::vector<std::string> docs_vector;
	docs_vector.push_back("<document><id>test_insert_one_document_partially_replace_it_retrieve_it_and_then_delete_it</id><title>Test document 1</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
	// Insert document
	CPS::InsertRequest insert_req(docs_vector);
	std::unique_ptr<CPS::InsertResponse> insert_resp(
			connection().sendRequest<CPS::InsertResponse>(insert_req));
