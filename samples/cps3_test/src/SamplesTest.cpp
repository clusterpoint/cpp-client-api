...
void SamplesTest::test_insert_sample()
{
  ...
  docs_vector.push_back(
      "<document><id>id1</id><title>Test document 1</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
  docs_vector.push_back(
      "<document><id>id2</id><title>Test document 2</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
  std::map<std::string, std::string> docs_map;
  docs_map["id3"] =
      "<document><title>Test document 3</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>";
  docs_map["id4"] =
      "<document><title>Test document 4</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>";
  ...
  insert_req.setDocument(
      "<document><id>id5</id><title>Test document 5</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
  insert_req.setDocument(
      "id6",
      "<document><title>Test document 3</title><body>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nisl magna</body></document>");
...
void SamplesTest::test_update_sample()
{
  ...
  CPS::UpdateRequest update_req(
      "<document><id>id1</id><title>Changed test document 1</title><body>Lorem ipsum dolor sit amet,  consectetur adipiscing elit. Nullam a nisl  magna</body></document>");
...
void SamplesTest::test_replace_sample()
{
  ...
  CPS::ReplaceRequest replace_req(
      "<document><id>id1</id><title>Changed test document 1</title><body>Lorem ipsum dolor sit amet,  consectetur adipiscing elit. Nullam a nisl  magna</body></document>");
...
void SamplesTest::test_partial_replace_sample()
{
  ...
  std::unique_ptr<CPS::PartialReplaceResponse> partial_replace_resp(
      conn->sendRequest<CPS::UpdateResponse>(partial_replace_req));
  // Print out modified ids
...
void SamplesTest::test_delete_sample()
{
  ...
  {
    if (it->code == "2824")
    { // Requested document does not exist error
      std::cout << it->text << ": " << CPS::Utils::join(it->documentIds) << std::endl;
    }
  }
...
void SamplesTest::test_list_paths_sample()
{
  ...
  std::unique_ptr<CPS::ListPathsResponse> lpaths_resp(
      conn->sendRequest<CPS::ListPathsResponse>(CPS::ListPathsRequest()));
